...
elseif ($option == 'student'){
  $sql = ("SELECT * FROM Clubs,Students,Organisers WHERE CONCAT(Students.StudentFirstName,' ',Students.StudentLastName) LIKE '%$search%' AND Students.clubID = Clubs.clubID AND Clubs.clubID = Organisers.clubID AND Students.clubID = Organisers.clubID");
}
//elseif($option == )
