...
<body>
  ...
  <p>
    <div class="main">
      <strong><font color =#3badf9><font size = 50px>Delete</font></font></strong>
    </div>
  </p>
  <div class="sidenav">
    <div class="navMain">
  ...
  <div class="formMain">
    <form id="MainForm" onsubmit="post();">
      ...
      <button type="Submit" id=button name=button>Delete</button>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
